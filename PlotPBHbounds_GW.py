...
listfile_default = "listfiles/bounds_GW.txt" 
outfile_default = "plots/PBHbounds_GW_square.pdf"
...
Mgrid, envelope = tools.getEnvelope(bounds, Mgrid, outfile = "GWs.txt")
...
plt.text(0.5, 0.05, "Gravitational Waves", va = "bottom", ha = "center", color='C4',  transform=plt.gca().transAxes, fontsize=16)
