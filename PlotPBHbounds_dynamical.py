...
Mgrid, envelope = tools.getEnvelope(bounds, Mgrid, outfile = "Dynamical.txt")
...
tools.setup_axes(fig, obj_label="CO")

plt.text(0.5, 0.05, "Dynamical", va = "bottom", ha = "center", color="C2",  transform=plt.gca().transAxes)
