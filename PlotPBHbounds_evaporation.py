...
headertxt = "Envelope of evaporation bounds: " + ", ".join(bounds)
headertxt += "\n Columns: PBH mass [Mun], PBH fraction f_PBH"
np.savetxt("bounds/Evaporation.txt", np.c_[Mgrid, envelope], header=headertxt)
